...
import (
    ...
    "github.com/wonktnodi/lollipop/pkg/proxy"
    ...
    "context"
    "strings"
    "github.com/wonktnodi/lollipop/pkg"
)
...
func EndpointHandler(configuration *config.EndpointConfig, proxy proxy.Proxy) gin.HandlerFunc {
    ...
    return func(c *gin.Context) {
        ...
        c.Header(pkg.LollipopHeaderName, pkg.LollipopHeaderValue)
...
var (
    ...
    userAgentHeaderValue = []string{pkg.LollipopUserAgent}
)
